<?php
	...
	// Delete an Staff's record after confirmation
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            ...
                            <p>Are you sure you want to delete the record for <?php echo ($_SESSION["staffId"]); ?>?</p><br>
